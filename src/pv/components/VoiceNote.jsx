...
export default function VoiceNote({ value, onChange, readOnly = false }) {
          ...
          {!value && !recording && (
            <button
              ...
              style={{
                ...
                background: "#fff0f0", border: "none", color: "#D32F2F",
      ...
      {recording && (
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <span style={{
              width: 10, height: 10, borderRadius: "50%", background: "#D32F2F",
          ...
          <button
            ...
            style={{
              ...
              background: "#D32F2F", border: "none", borderRadius: 999,
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ height: 4, background: "#e5e7eb", borderRadius: 999, overflow: "hidden" }}>
              <div style={{
                height: "100%", background: "#D32F2F", borderRadius: 999,
