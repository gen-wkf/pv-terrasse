import PVView from "./PVView.jsx";
import { I } from "../icons.jsx";

export const renderSplashScreen = (toasts) => (
  <>
    <div className="shell">
...
export const renderHomeScreen = (viewPV, filteredPVs, search, onSearch, onViewPV, onOpenNewPV, onOpenEditPV, onOpenPDF, onGoHome, toasts, CURRENT_USER) => {
      ...
      <div className="shell">
        {viewPV ? (
          <PVView
            pv={viewPV}
            onBack={() => onGoHome()}
            onPDF={() => onOpenPDF(viewPV)}
            onEdit={() => onOpenEditPV(viewPV)}
            onGoHome={onGoHome}
          />
        ) : (
          <div className="scr fade-in">
            <div className="topbar">
              ...
              <div className="tb-avatar" style={{ background: "#1a1a3e" }}>
                {initials}
              </div>
            </div>
            ...
            <div className="cnt fade-in">
              ...
              {filteredPVs.length === 0 ? (
                <div className="empty-state">
                  ...
                  <button className="btn-red" onClick={onOpenNewPV}>
                    <I.Plus /> Créer un nouveau PV
                  </button>
                </div>
              ) : (
                <>
                  <div className="list-hdr">
                    ...
                    <span className="list-cnt">
                      {filteredPVs.length} rapport{filteredPVs.length > 1 ? "s" : ""}
                    </span>
                  </div>
            ...
            <button className="fab" onClick={onOpenNewPV}>
              <I.Plus />
            </button>
          </div>
        )}
